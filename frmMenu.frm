...
Begin VB.Form frmMenu 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "Btnmed1"
      Tab(1).Control(1)=   "Btnmed2"
      Tab(1).Control(2)=   "Btnsmall3"
      Tab(1).Control(3)=   "Btnmed3"
      Tab(1).Control(4)=   "Btnsmall4"
      Tab(1).Control(5)=   "Btnlrge2"
      Tab(1).Control(6)=   "Btnmed4"
      Tab(1).Control(7)=   "Btnlrge1"
      Tab(1).Control(8)=   "Btnsmall1"
      Tab(1).Control(9)=   "Btnsmall2"
      Tab(1).Control(10)=   "Btnlrge4"
      Tab(1).Control(11)=   "Btnlrge3"
      Tab(1).ControlCount=   12
      TabCaption(2)   =   "Special Items"
      TabPicture(2)   =   "frmMenu.frx":3BCC0
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Btnspl1"
      Tab(2).Control(1)=   "Btnspl3"
      Tab(2).Control(2)=   "Btnspl2"
      Tab(2).Control(3)=   "Btnspl4"
      Tab(2).Control(4)=   "Btnspl5"
      Tab(2).Control(5)=   "Btnspl6"
      Tab(2).Control(6)=   "Btnspl7"
      Tab(2).Control(7)=   "Btnspl8"
      Tab(2).Control(8)=   "Btnspl9"
      Tab(2).Control(9)=   "Btnspl10"
      Tab(2).Control(10)=   "Btnspl11"
      Tab(2).Control(11)=   "Btnspl12"
